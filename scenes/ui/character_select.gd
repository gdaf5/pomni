...
@onready var gojo_btn: Button = $HBox/GojoCard/VBox/GojoButton
...
func _ready() -> void:
	...
	gojo_btn.pressed.connect(_on_gojo_button_pressed)
...
func _on_gojo_button_pressed() -> void:
	GameManager.selected_character = GameManager.CharacterType.GOJO
	get_tree().change_scene_to_file("res://scenes/world/world.tscn")
